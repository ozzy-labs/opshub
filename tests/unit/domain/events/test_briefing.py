...
:data:`AllEvent` discriminated union. The shape mirrors ``test_phase4.py``
...
- ``AllEvent`` still dispatches to Phase 1 / 2 / 3 / 4 events
...
# ---- AllEvent dispatch for Phase 5 event types ----------------------------
