"""Gmail connector settings (re-export shim).
...
:class:`OpsHubSettings` covers the operator surface". This shim
re-exports the canonical class under
``opshub.connectors.google_mail.settings`` so that:
