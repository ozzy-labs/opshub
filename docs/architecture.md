...
Phase 10 C2 baseline + Step 1 widening (PR #231) + Phase 12 H1 (ADR-0022 改訂 §決定 (f)) + Phase 18-C (ADR-0033 §決定 (c)) + Phase 21-D (ADR-0037 §決定 (e) + ADR-0022 改訂 §決定 (g)) で出荷した tool 一覧 (`src/opshub/mcp/_registry.py`、計 **19 tools = read 13 + write 6**):
