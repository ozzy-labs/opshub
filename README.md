...
opshub connector slack conversations                  # list joined conversations (channels + DMs) for [connectors.slack] channels (use --format toml to paste)
